...
class OrderDetailsRepository {
  ...
  Future<OrderDetailsModel> orderDetailsApiResponse(dynamic data, BuildContext context,String sessionId) async {
    try {
      dynamic response = await _apiServices.postOrderDetailsApiResponse(AppUrl.getOrderDetails, data, context,sessionId);
