...
class CancelOrderRepository {
  ...
  Future<CancelOrderModel> cancelOrderApiResponse(dynamic data, BuildContext context,String sessionId) async {
    try {
      dynamic response = await _apiServices.postCancelOrderApiResponse(AppUrl.cancelOrderApi, data, context,sessionId);
