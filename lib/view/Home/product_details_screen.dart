...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final addToWhishListViewModel = Provider.of<AddToWhishListViewModel>(context, listen: false);
          ...
          return Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                print("fdygdvghs"+productDetails.isInWishlist.toString());
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: NetworkImage('https://towanto-ecommerce-mainbranch-16118324.dev.odoo.com/web/image?model=product.product&id=${productDetails.id}&field=image_1920'),
                                fit: BoxFit.contain,
                              ),
                            ),
                          ),
                        ...
                        Row(
                          children: [
                            ...
                            Text('(${productDetails.ratingCount} review${productDetails.ratingCount > 1 ? 's' : ''})',style: TextStyle(
                              fontSize: 14,
                        ...
                        Theme(
                          ...
                          child: ListTileTheme(
                            ...
                            child: ExpansionTile(
                              ...
                              children: [
                                _buildDetailRow('Crop:', productDetails.crop.toString()),
                                _buildDetailRow('Variety:', productDetails.variety.toString()),
                                _buildDetailRow('Company:', productDetails.productCompany),
                        ...
                        Consumer<AddToWhishListViewModel>(
                          builder: (context, viewModel, child) {
                           print("dscdecade"+productDetails.isInWishlist.toString());
                            return TextButton.icon(
                              ...
                              label: Text(
                                viewModel.isInWhishList || productDetails.isInWishlist ? 'In Wishlist' : 'Add to Wishlist',
                                style: TextStyle(
                                  color: Colors.red,
                                  fontSize: 16,
                                  fontFamily: MyFonts.Lexenddeca_regular,
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle( fontSize: 12,
                  fontFamily: MyFonts.Lexenddeca_regular,fontWeight: FontWeight.normal, color:  AppColors.textbox_textcolor),
            ),
          ),
        ],
      ),
