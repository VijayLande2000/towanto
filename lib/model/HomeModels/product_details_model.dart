class ProductDetailsModel {
  ...
  factory ProductDetailsModel.fromJson(Map<dynamic, dynamic> json) {
    return ProductDetailsModel(
      ...
      id: json['id'],
      activityIds: List<dynamic>.from(json['activity_ids']),
      ...
      messageFollowerIds: List<dynamic>.from(json['message_follower_ids']),
      messagePartnerIds: List<dynamic>.from(json['message_partner_ids']),
      messageIds: List<dynamic>.from(json['message_ids']),
      hasMessage: json['has_message'],
      messageNeedAction: json['message_need_action'],
      messageNeedActionCounter: json['message_need_action_counter'],
      ...
      ratingIds: List<dynamic>.from(json['rating_ids']),
      websiteMessageIds: List<dynamic>.from(json['website_message_ids']),
      messageHasSmsError: json['message_has_sms_error'],
      priceExtra: double.tryParse(json['price_extra'].toString()) ?? 0.0,
      lstPrice: double.tryParse(json['lst_price'].toString()) ?? 0.0,
      defaultCode: json['default_code'],
      code: json['code'],
      partnerRef: json['partner_ref'],
      active: json['active'],
      productTmplId: List<dynamic>.from(json['product_tmpl_id']),
      barcode: json['barcode'],
      productTemplateAttributeValueIds: List<dynamic>.from(json['product_template_attribute_value_ids']),
      productTemplateVariantValueIds: List<dynamic>.from(json['product_template_variant_value_ids']),
      combinationIndices: json['combination_indices'],
      isProductVariant: json['is_product_variant'],
      standardPrice: json['standard_price'] is double
          ? json['standard_price']
          : double.tryParse(json['standard_price'].toString()) ?? 0.0,

      volume: json['volume'] is double
          ? json['volume']
          : double.tryParse(json['volume'].toString()) ?? 0.0,
      ...
      productDocumentIds: List<dynamic>.from(json['product_document_ids']),
      productDocumentCount: json['product_document_count'],
      packagingIds: List<dynamic>.from(json['packaging_ids']),
      additionalProductTagIds: List<dynamic>.from(json['additional_product_tag_ids']),
      allProductTagIds: List<dynamic>.from(json['all_product_tag_ids']),
      ...
      createUid: List<dynamic>.from(json['create_uid']),
      createDate: json['create_date'],
      writeUid: List<dynamic>.from(json['write_uid']),
      taxdynamic: json['tax_dynamic'],
      stockQuantIds: List<dynamic>.from(json['stock_quant_ids']),
      stockMoveIds: List<dynamic>.from(json['stock_move_ids']),
      qtyAvailable: json['qty_available'] is double
          ? json['qty_available']
          : double.tryParse(json['qty_available'].toString()) ?? 0.0,

      virtualAvailable: json['virtual_available'] is double
          ? json['virtual_available']
          : double.tryParse(json['virtual_available'].toString()) ?? 0.0,

      freeQty: json['free_qty'] is double
          ? json['free_qty']
          : double.tryParse(json['free_qty'].toString()) ?? 0.0,

      incomingQty: json['incoming_qty'] is double
          ? json['incoming_qty']
          : double.tryParse(json['incoming_qty'].toString()) ?? 0.0,

      outgoingQty: json['outgoing_qty'] is double
          ? json['outgoing_qty']
          : double.tryParse(json['outgoing_qty'].toString()) ?? 0.0,

      orderpodynamicIds: json['orderpodynamic_ids'] != null
          ? List<dynamic>.from(json['orderpodynamic_ids'])
          : [],
      ...
      reorderingMinQty: json['reordering_min_qty'] != null
          ? json['reordering_min_qty'].toDouble()
          : 0.0, // Default value if null
      reorderingMaxQty: json['reordering_max_qty'] != null
          ? json['reordering_max_qty'].toDouble()
          : 0.0, // Default value if null
      putawayRuleIds: List<dynamic>.from(json['putaway_rule_ids']),
      storageCategoryCapacityIds: List<dynamic>.from(json['storage_category_capacity_ids']),
    ...
    mrpProductQty: double.tryParse(json['mrp_product_qty'].toString()) ?? 0.0,
      listPrice: double.tryParse(json['list_price'].toString()) ?? 0.0,
      isKits: json['is_kits'],
        valueSvl: double.tryParse(json['value_svl'].toString()) ?? 0.0,
        quantitySvl: double.tryParse(json['quantity_svl'].toString()) ?? 0.0,
        avgCost: double.tryParse(json['avg_cost'].toString()) ?? 0.0,
        totalValue: double.tryParse(json['total_value'].toString()) ?? 0.0,

      companyCurrencyId: json['company_currency_id'],
      stockValuationLayerIds: List<dynamic>.from(json['stock_valuation_layer_ids']),
      valuation: json['valuation'],
      costMethod: json['cost_method'],
      salesCount: json['sales_count'],
      productCatalogProductIsInSaleOrder: json['product_catalog_product_is_in_sale_order'],
      productVariantImageIds: List<dynamic>.from(json['product_variant_image_ids']),
      ...
      status: json['status'],
      stockNotificationPartnerIds: List<dynamic>.from(json['stock_notification_partner_ids']),
      ...
      costCurrencyId: json['cost_currency_id'],
      ...
      sellerIds: List<dynamic>.from(json['seller_ids']),
      variantSellerIds: List<dynamic>.from(json['variant_seller_ids']),
      color: json['color'],
      attributeLineIds: List<dynamic>.from(json['attribute_line_ids']),
      validProductTemplateAttributeLineIds: List<dynamic>.from(json['valid_product_template_attribute_line_ids']),
      productVariantIds: List<dynamic>.from(json['product_variant_ids']),
      ...
      productTagIds: List<dynamic>.from(json['product_tag_ids']),
      productProperties: List<dynamic>.from(json['product_properties']),
      taxesId: List<dynamic>.from(json['taxes_id']),
      supplierTaxesId: List<dynamic>.from(json['supplier_taxes_id']),
      propertyAccountIncomeId: json['property_account_income_id'],
      propertyAccountExpenseId: json['property_account_expense_id'],
      accountTagIds: List<dynamic>.from(json['account_tag_ids']),
      ...
      optionalProductIds: List<dynamic>.from(json['optional_product_ids']),
      hsCode: json['hs_code'],
      ...
      alternativeProductIds: List<dynamic>.from(json['alternative_product_ids']),
      accessoryProductIds: List<dynamic>.from(json['accessory_product_ids']),
      ...
      publicCategIds: List<dynamic>.from(json['public_categ_ids']),
      productTemplateImageIds: List<dynamic>.from(json['product_template_image_ids']),
    compareListPrice: double.tryParse(json['compare_list_price'].toString()) ?? 0.0,
      ...
      productPrice: double.tryParse(
          json['product_price'].toString().replaceAll(RegExp(r'[^0-9.]'), '')
      ) ?? 0.0,

      productWeight: double.tryParse(
          json['product_weight'].toString().replaceAll(RegExp(r'[^0-9.]'), '')
      ) ?? 0.0,
        xStudioPricePerUnit: double.tryParse(json['x_studio_price_per_unit'].toString()) ?? 0.0,
  ...
  Map<dynamic, dynamic> toJson() {
    return {
      ...
      'message_need_action': messageNeedAction,
      'message_need_action_counter': messageNeedActionCounter,
      ...
      'product_template_variant_value_ids': productTemplateVariantValueIds,
      'combination_indices': combinationIndices,
      'is_product_variant': isProductVariant,
      'standard_price': standardPrice,
      'volume': volume,
      'weight': weight,
      'pricelist_item_count': pricelistItemCount,
      'product_document_ids': productDocumentIds,
      'product_document_count': productDocumentCount,
      'packaging_ids': packagingIds,
      'additional_product_tag_ids': additionalProductTagIds,
      'all_product_tag_ids': allProductTagIds,
      'image_variant_1920': imageVariant1920,
      'image_variant_1024': imageVariant1024,
      'image_variant_512': imageVariant512,
      'image_variant_256': imageVariant256,
      'image_variant_128': imageVariant128,
      'can_image_variant_1024_be_zoomed': canImageVariant1024BeZoomed,
      'image_1920': image1920,
      'image_1024': image1024,
      'image_512': image512,
      'image_256': image256,
      'image_128': image128,
      'can_image_1024_be_zoomed': canImage1024BeZoomed,
      'product_template_image_ids': productTemplateImageIds,
      // 'product_video_ids': productVideoIds,
      // 'product_video_count': productVideoCount,
      // 'bundle_items': bundleItems,
      'bom_ids': bomIds,
      'bom_line_ids': bomLineIds,
      'bom_count': bomCount,
      'used_in_bom_count': usedInBomCount,
      'mrp_product_qty': mrpProductQty,
      'is_kits': isKits,
      'value_svl': valueSvl,
      'quantity_svl': quantitySvl,
      'avg_cost': avgCost,
      'total_value': totalValue,
      'company_currency_id': companyCurrencyId,
      'stock_valuation_layer_ids': stockValuationLayerIds,
      'valuation': valuation,
      'cost_method': costMethod,
      'sales_count': salesCount,
      'product_catalog_product_is_in_sale_order': productCatalogProductIsInSaleOrder,
      'product_variant_image_ids': productVariantImageIds,
      ...
      'seller_id': sellerId,
      'status': status,
      'stock_notification_partner_ids': stockNotificationPartnerIds,
      ...
      'variant_seller_ids': variantSellerIds,
      'color': color,
      'attribute_line_ids': attributeLineIds,
      'valid_product_template_attribute_line_ids': validProductTemplateAttributeLineIds,
      'product_variant_ids': productVariantIds,
      'product_variant_id': productVariantId,
      'product_variant_count': productVariantCount,
      'has_configurable_attributes': hasConfigurableAttributes,
      ...
      'property_account_income_id': propertyAccountIncomeId,
      'property_account_expense_id': propertyAccountExpenseId,
      'account_tag_ids': accountTagIds,
      ...
      'description_pickingout': descriptionPickingout,
      'description_pickingin': descriptionPickingin,
      'location_id': locationId,
      'warehouse_id': warehouseId,
      'has_available_route_ids': hasAvailableRouteIds,
      'route_ids': routeIds,
      'route_from_categ_ids': routeFromCategIds,
      'bom_ids': bomIds,
      ...
      'sale_line_warn': saleLineWarn,
      'sale_line_warn_msg': saleLineWarnMsg,
      'expense_policy': expensePolicy,
      'visible_expense_policy': visibleExpensePolicy,
      'invoice_policy': invoicePolicy,
      'product_brand_id': productBrandId,
      'optional_product_ids': optionalProductIds,
      'hs_code': hsCode,
      'country_of_origin': countryOfOrigin,
      'rating_last_value': ratingLastValue,
      'rating_last_feedback': ratingLastFeedback,
      'rating_last_image': ratingLastImage,
      'rating_count': ratingCount,
      'rating_avg': ratingAvg,
      'rating_avg_text': ratingAvgText,
      'rating_percentage_satisfaction': ratingPercentageSatisfaction,
      'rating_last_text': ratingLastText,
      'website_description': websiteDescription,
      'description_ecommerce': descriptionEcommerce,
      'alternative_product_ids': alternativeProductIds,
      'accessory_product_ids': accessoryProductIds,
      'website_size_x': websiteSizeX,
      'website_size_y': websiteSizeY,
      'website_ribbon_id': websiteRibbonId,
      'website_sequence': websiteSequence,
      'public_categ_ids': publicCategIds,
      'product_template_image_ids': productTemplateImageIds,
      'compare_list_price': compareListPrice,
      'shop_id': shopId,
      'allow_out_of_stock_order': allowOutOfStockOrder,
      'available_threshold': availableThreshold,
      ...
      'product_technical_name': productTechnicalName,
      'crop': crop,
      'variety': variety,
      'quantity_slab': quantitySlab,
      'per_case_bag': perCaseBag,
...
class Activity {
  ...
  Activity({this.id, this.name, this.color});
...
class ProductSupplier {
  ...
  factory ProductSupplier.fromJson(Map<dynamic, dynamic> json) {
...
class Partner {
  ...
  Partner({this.id, this.name, this.email});
...
class ProductTemplate {
  ...
  ProductTemplate({this.id, this.name});

  factory ProductTemplate.fromJson(Map<dynamic, dynamic> json) {
